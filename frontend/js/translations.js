...
export const translations = {
    ru: {
        ...
        canHearDifference: "Вы слышите разницу даже между 320kbps и flac!",
        cannotHearDifference: "Вы не слышите разницу между {quality} и flac.",
    ...
    en: {
        ...
        canHearDifference: "You can hear the difference even between 320kbps and flac!",
        cannotHearDifference: "You can't hear the difference between {quality} and flac.",
    ...
    es: {
        ...
        canHearDifference: "¡Puedes escuchar la diferencia incluso entre 320kbps y flac!",
        cannotHearDifference: "No puedes escuchar la diferencia entre {quality} y flac.",
    ...
    zh: {
        ...
        currentTrack: "当前曲目:",
        selectLanguage: "选择语言:",
        canHearDifference: "您可以听到 320kbps 和 flac 之间的差异！",
        cannotHearDifference: "您听不到 {quality} 和 flac 之间的差异。",
    ...
    de: {
        ...
        canHearDifference: "Sie können den Unterschied sogar zwischen 320kbps und flac hören!",
        cannotHearDifference: "Sie können den Unterschied zwischen {quality} und flac nicht hören.",
    ...
    fr: {
        ...
        canHearDifference: "Vous pouvez entendre la différence même entre 320kbps et flac !",
        cannotHearDifference: "Vous n'entendez pas la différence entre {quality} et flac.",
